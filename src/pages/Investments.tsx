    ...
    <DashboardLayout>
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="stat-card"><span className="text-xs text-muted-foreground">{t("totalValue")}</span><p className="text-lg font-bold">{fmt(portfolioValue)}</p></div>
          <div className="stat-card"><span className="text-xs text-muted-foreground">{t("totalCost")}</span><p className="text-lg font-bold">{fmt(totalCost)}</p></div>
          <div className={totalGain >= 0 ? "stat-card-success" : "stat-card-destructive"}><span className="text-xs text-muted-foreground">{t("totalGain")}</span><p className={`text-lg font-bold ${totalGain >= 0 ? "text-success" : "text-destructive"}`}>{fmt(totalGain)}</p></div>
          <div className="stat-card"><span className="text-xs text-muted-foreground">{t("assets")}</span><p className="text-lg font-bold">{investments.length}</p></div>
        </div>
